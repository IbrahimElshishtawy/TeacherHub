...
import 'package:student/features/admin/admin_home/bindings/home_binding.dart';
import 'package:student/features/admin/admin_home/view/home_page/home_page.dart';
import 'package:student/features/admin/attendance/binding/attendance_binding.dart';
import 'package:student/features/admin/attendance/view/attendance_screen.dart';
import 'package:student/features/admin/courses/binding/courses_binding.dart';
import 'package:student/features/admin/courses/view/course_details_screen.dart';
import 'package:student/features/admin/courses/view/courses_screen.dart';
import 'package:student/features/admin/exams_reviews_results/bindings/exams_rr_binding.dart';
import 'package:student/features/admin/exams_reviews_results/view/exams_rr_screen.dart';
import 'package:student/features/admin/payments/binding/payments_binding.dart';
import 'package:student/features/admin/payments/view/payments_screen.dart';
import 'package:student/features/admin/reports/binding/reports_binding.dart';
import 'package:student/features/admin/reports/view/reports_screen.dart';
import 'package:student/features/admin/setting/binding/setting_binding.dart';
import 'package:student/features/admin/setting/view/setting_screen.dart';
import 'package:student/features/admin/teachers/bindings/teachers_binding.dart';
import 'package:student/features/admin/teachers/view/teacher_account_screen.dart';
import 'package:student/features/admin/teachers/view/teacher_analytics_screen/teacher_analytics_screen.dart';
import 'package:student/features/admin/teachers/view/teacher_form_screen/teacher_form_screen.dart';
import 'package:student/features/admin/teachers/view/teacher_permissions_screen/teacher_permissions_screen.dart';
import 'package:student/features/admin/user_management/bindings/user_management_binding.dart';
import 'package:student/features/admin/user_management/view/parents.dart';
import 'package:student/features/admin/user_management/view/students.dart';
import 'package:student/features/admin/user_management/view/user_management_screen.dart';
import 'package:student/auth/binding/student_register_binding.dart';
import 'package:student/auth/view/Onboarding/Onboarding_Screen.dart';
import 'package:student/auth/view/login/admin_login/Error_401_Page.dart';
import 'package:student/auth/view/login/admin_login/Error_403_Page.dart';
import 'package:student/auth/view/login/admin_login/admin_login_screen.dart';
import 'package:student/auth/view/login/admin_login/forget_password_admin.dart';
